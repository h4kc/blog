...
export default function Home() {
  return (
    ...
    <div className=' p-10 flex flex-wrap-reverse  justify-around'>
      <div className=' w-96 flex flex-col justify-center mt-5'>
        ...
        <span className='text-xl'>It's all about The impact</span>
    ...
    <h1 className='text-2xl font-bold text-orange-300 flex  items-center'>
          <span className='border-2 w-3 inline-block mr-1 mt-0.5 border-red-600'></span>Services 
        </h1>
        <div className='flex flex-wrap justify-center items-center p-5'>
          {data.services.map(a=><div className=' rounded m-2 w-80 p-3 flex items-center border-gray-100 border-2'>
            {a.icon}
    ...
    <h1 className='text-2xl font-bold text-red-600 flex  items-center'>
          <span className='border-2 w-3 inline-block mr-1 mt-0.5 border-orange-300'></span>Technologies
        </h1>
        <div className='flex flex-wrap justify-center items-center p-5 '>
          {data.skills.map(a=><div key={a.name} className='m-2 w-44 p-3 flex justify-between items-center flex-col  rounded border-gray-100 border-2 h-40'>
  ...
  <div className="bg-gray-300 rounded">
    <div className="flex items-center justify-center rounded bg-black text-xs leading-none" style={{width: a.progress}}>
    ...
    <div className='flex flex-col  pl-10'>
    <h1 className='text-2xl font-bold text-orange-300 flex  items-center'>
          <span className='border-2 w-3 inline-block mr-1 mt-0.5 border-red-600'></span>Tools
        </h1>
        <div className='flex flex-wrap justify-center items-center p-5 '>
          {data.tools.map(a=><div key={a} className='m-2 w-44 p-3 flex justify-between items-center flex-col  h-40'>
         <div className=' flex flex-1 items-center'>
          <Image
          src={"/"+a+".png"}
          alt={a}
